...
const targetStr = "<p>Best,</p><p><strong>Jamieswaran Ilkumar</strong><br>Founder & CEO<br>Vyntyra Consultancy Services</p><p><img src=\"\/signature.png\" alt=\"Founder Signature\" style=\"max-width: 150px;\" /></p>";
...
console.log('Replaced the other instance');
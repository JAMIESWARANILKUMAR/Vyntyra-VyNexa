  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <motion.div whileHover={{ y: -3 }} className="p-5 rounded-3xl bg-white border border-emerald-200/80 backdrop-blur-xl shadow-xl shadow-emerald-950/5 space-y-2">
        ...
        <motion.div whileHover={{ y: -3 }} className="p-5 rounded-3xl bg-white border border-emerald-200/80 backdrop-blur-xl shadow-xl shadow-emerald-950/5 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono font-black text-emerald-800 bg-emerald-100 px-2 py-0.5 rounded-full border border-emerald-300">VERIFIED</span>
          </div>
      ...
      <div className="rounded-2xl bg-gradient-to-r from-white via-slate-50 to-white text-slate-900 p-6 shadow-xl shadow-emerald-950/5 border border-emerald-200/80 space-y-3">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-emerald-100 text-emerald-600 flex items-center justify-center border border-emerald-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-5 rounded-2xl bg-white text-slate-900 shadow-xl shadow-emerald-950/5 border border-emerald-200/80 space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black uppercase text-emerald-600">Milestone & Ops Velocity</span>
        ...
        <div className="p-5 rounded-2xl bg-white text-slate-900 shadow-xl shadow-emerald-950/5 border border-emerald-200/80 space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black uppercase text-emerald-600">Executive Deliverables</span>
        ...
        <div className="p-5 rounded-2xl bg-white text-slate-900 shadow-xl shadow-emerald-950/5 border border-emerald-200/80 space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs font-black uppercase text-emerald-600">Operations Action Queue</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              standups.map((s: any, idx: number) => (
                <div key={idx} className="p-3.5 rounded-xl border bg-slate-50 space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className={`px-2 py-0.5 rounded font-bold text-[10px] uppercase ${s.status === "approved" ? "bg-emerald-100 text-emerald-800" : "bg-emerald-100 text-emerald-800"}`}>
                      {s.status}
                    </span>
                  </div>
                </div>
        ...
        <div className="rounded-xl border bg-white p-6 shadow-sm space-y-4">
          <h3 className="font-semibold text-slate-900 text-sm flex items-center gap-2">
            <FileCheck className="h-4 w-4 text-emerald-600" /> Executive Action Center
          </h3>

...
// Replace the entire job details card and onwards.
const targetStart = '// \uD83D\uDD39 JOB DETAILS CARD (Structured Premium Table Layout) \uD83D\uDD39';
...
const replacement = `// \uD83D\uDD39 JOB DETAILS SECTION (Minimalist Corporate Premium) \uD83D\uDD39
  const cardY = 115;

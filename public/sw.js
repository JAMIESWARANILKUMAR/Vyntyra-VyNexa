// VyNexa Connect — minimal service worker to satisfy PWA install criteria.
// Uses NetworkFirst for navigations so users always see fresh content when online.
const CACHE = "vynexa-connect-v1";
